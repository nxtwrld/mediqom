...
vi.mock("$lib/context/mcp-tools/medical-expert-tools", () => ({
...
import { ClientChatContextService } from "./chat-context-client";

describe("ClientChatContextService", () => {
  let service: ClientChatContextService;

  beforeEach(() => {
    service = new ClientChatContextService();
