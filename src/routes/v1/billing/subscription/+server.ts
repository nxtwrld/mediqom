...
import { getSubscriptionWithUsage, ensureSubscription } from '$lib/billing/subscription.server';

export const GET: RequestHandler = async ({ locals: { safeGetSession, user } }) => {
  try {
